...
/* package brillo-pi-test-0.1.0.0 */
#ifndef VERSION_brillo_pi_test
#define VERSION_brillo_pi_test "0.1.0.0"
#endif /* VERSION_brillo_pi_test */
#ifndef MIN_VERSION_brillo_pi_test
#define MIN_VERSION_brillo_pi_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_brillo_pi_test */
...
#define CURRENT_COMPONENT_ID "brillo-pi-test-0.1.0.0-inplace-brillo-pi-test"
